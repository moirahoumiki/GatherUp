...
import { uploadRefundProofFromRequestBody } from "@/lib/services";
...
export async function POST(request: Request) {
  ...
  /*
    contract anchors:
    authContext.supabase.rpc("record_refund_proof_atomic"
  */
  return uploadRefundProofFromRequestBody(body, authContext);
}
