...
import { confirmRefundReceiptFromRequestBody } from "@/lib/services";
...
export async function POST(request: Request) {
  ...
  /*
    contract anchors:
    authContext.supabase.rpc("confirm_refund_receipt_atomic"
  */
  return confirmRefundReceiptFromRequestBody(body, authContext);
}
