...
import { listOrganizerVerifications, reviewOrganizerVerification } from "@/lib/services";
...
export async function GET(request: Request) {
  ...
  return listOrganizerVerifications();
}
...
export async function POST(request: Request) {
  ...
  return reviewOrganizerVerification(body, adminCheck.appUser.id);
}
